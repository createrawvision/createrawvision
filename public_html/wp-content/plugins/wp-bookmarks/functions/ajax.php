...
function wpb_grid_print_bookmark() {
	...
	if ( is_array( $bks ) ){
		...
		ob_start();
		?>
		<div class="wpb-single-bmcount collection_<?php echo $id;?>"><span><?php echo $wpb->get_bookmarks_count_by_collection($id); echo __(' Bookmarks in collection','wpb');?></span></div>
		<?php 
...
/******************************************************************Code End*******************************************************************/
	...
	function wpb_save_new_collection() {
		...
		$new_collection = array( $collection_id => array("label"=>$collection_title,"privacy"=>$collection_privacy ));
